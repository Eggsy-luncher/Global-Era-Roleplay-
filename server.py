...
class Handler(SimpleHTTPRequestHandler):
    ...
    def check_admin(self):
        pwd = self.headers.get("X-Admin-Password") or ""
...
<head>
  ...
  <style>
    ...
    h1{color:#f5cf22} input,button{padding:10px;margin:6px 0;width:100%;box-sizing:border-box;
...
if __name__ == "__main__":
    print("=" * 50)
    print("  GLOBAL ERA RP — Simple Backend (no deps)")
    print("=" * 50)
